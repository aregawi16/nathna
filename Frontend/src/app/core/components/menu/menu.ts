...
export const menuItems = [
    new Menu (10, 'ADMIN_NAV.DASHBOARD', '/', null, 'dashboard', null, false, 0),
     ...
     new Menu (60, 'ADMIN_NAV.USER', "", null, 'person', null, true, 0),
     new Menu (510, 'ADMIN_NAV.USER', "/identity/user", null, 'person_add', null, false, 60),
     new Menu (520, 'ADMIN_NAV.ROLE', "/identity/role", null, 'person', null, false, 60),
