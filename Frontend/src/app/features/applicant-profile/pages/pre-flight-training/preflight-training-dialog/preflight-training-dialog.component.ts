...
@Component({
  selector: 'app-preflight-training-dialog',
  templateUrl: './preflight-training-dialog.component.html',
  styleUrls: ['./preflight-training-dialog.component.scss']
})
export class PreflightTrainingDialogComponent implements OnInit {
...
submitPreflightTraining()
{
  ...
  this._processManagementService.schedulePreflightTraining(this.preflightTrainingFormGroup.value)
  .subscribe(data => {

    this._snackBar.open('Training Scheduled successfully', 'Undo', {
      duration:10000,
